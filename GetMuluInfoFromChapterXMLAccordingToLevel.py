...
"""
@Project: JinRong
@Time: 2019/1/15 14:32
@Name: GetMuluInfoFromChapterXMLAccordingToLevel
@Author: lieyan123091
处理第二批跟第三批数据，按照层级处理改进
"""
import os
import sys
...
def main():
    # 配置数据
    # srcdir = u"I:\\Deal-Middle\\图书数据\\Chapter_XML\\第三批数据"
    srcdir = u"I:\\Deal-Middle\\图书数据\\Chapter_XML\\第二批数据"
